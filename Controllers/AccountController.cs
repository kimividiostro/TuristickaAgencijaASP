...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            #region MojihRukuDelo
            /* AKO SE KORISNIK USPENSO ULOGOVAO
             * SIMULIRAJ SLANJE MEJLA SA VERIFIKACIONIM KODOM
             * MEJL SE PO DIFOLTU CUVA NA C:\ */
            ...
            if (user != null)
            {
                ...
                var mailMessage = new System.Net.Mail.MailMessage("admin@agencija.com ",
                            user.Email,
                            "Verifikacioni kod",
                            $"Unesite navedeni kod kako biste se ulogovali na svoj nalog: {code}"
                            );
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Potvrdite svoju email adresu", "Molimo vas da potvrdite svoju email adresu klikom na link: " + callbackUrl);
